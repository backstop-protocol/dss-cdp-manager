...
contract VatDeployer {
    ...
    FakeDaiToUsdPriceFeed public daiToUsdPriceFeed;
    ...
    constructor() public {
        ...
        pool = new Pool(address(vat), address(0x12345678), address(spotter), address(new FakeJug()), address(daiToUsdPriceFeed));
